...
const THEMES = [
  {
    id: 'vault-tec',
    name: 'Vault-Tec',
    description: 'Vault gold on green-black (default)',
    colors: {
      bg: '#0a0d0a',
      accent: '#ffd200',
      success: '#7bb661',
  ...
  },
  {
    id: 'nuclear',
    name: 'Nuclear',
    description: 'Radioactive green terminal',
    colors: {
      bg: '#0a0e0a',
      accent: '#39ff14',
      success: '#39ff14',
  ...
  },
  {
    id: 'monochrome',
    name: 'Monochrome',
    description: 'Grayscale terminal',
    colors: {
      bg: '#080808',
      accent: '#cccccc',
      success: '#44cc66',
      ...
      <section className="vault-card overflow-hidden">
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="pt-3 border-t border-border/30">
            ...
            <button
              onClick={() => window.electronAPI.openExternal('https://whydonate.com/donate/asicpoolspace')}
              title="Support asicpool.space — keep it free & zero-fee"
