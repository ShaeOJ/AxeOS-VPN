    ...
    <div className="flex flex-1 overflow-hidden">
      ...
      <aside className="w-64 min-w-[200px] bg-bg-secondary border-r-2 border-border flex flex-col relative">
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden flex flex-col min-h-0">
          {/* Navigation (top) */}
          <nav className="py-2 border-b border-border/30 flex-shrink-0">
          ...
          {/* Mining Profitability (earnings) */}
          <ProfitabilityDisplay />

          {/* System Status - Pip-Boy Style */}
          ...
          {/* Fleet share-globe — fills the gap above Network Access */}
          <div className="flex-1 min-h-[150px] border-b border-border/30 bg-bg-tertiary/20">
            <MiniGlobe devices={devices} />
          </div>
        </div>
